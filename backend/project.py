...
#classfication Using random forest and regression using decision tree
predicted_fertility=run_randomForests_classification(X_fer_train, X_fer_test, y_fer_train, y_fer_test,fertility_columns_test)    
...
print("Predicted Values Using Random Forest as Classification and Decision Tree Regression : \n")
print("Predicted Fertility using random forest classification : \n",predicted_fertility)
print("Predicited rainfall using Decision Tree regression : \n",predicted_rainfall)
...
class MainWindow1(wx.Frame):
    def __init__(self, *args, **kwargs):
        ...
        for a in range(len(crop2)):        
            self.list.Append([ crop2[a]])
...
#classification using decision tree and regression using random forest
...
predicted_rainfall=run_randomForests_regression(X_rainfall_train, X_rainfall_test, y_rainfall_train, y_rainfall_test,rainfall_column_test)
print("Predicted Values Using Decision Tree as Classification and Random Forest Regression : \n")
print("Predicted Fertility using Decision Tree classification : \n",predicted_fertility)
print("Predicited rainfall using random forest regression : \n",predicted_rainfall)
...
class MainWindow3(wx.Frame):
    def __init__(self, *args, **kwargs):
        ...
        for a in range(len(crop3)):        
            self.list.Append([ crop3[a]])
...
#classfication Using decision tree and regression using decision tree
predicted_fertility=run_decision_tree_classification(X_fer_train, X_fer_test, y_fer_train, y_fer_test,fertility_columns_test)
predicted_rainfall=run_decision_tree_regression(X_rainfall_train, X_rainfall_test, y_rainfall_train, y_rainfall_test,rainfall_column_test)
print("Predicted Values Using Decision Tree as Classification and Decision Tree Regression : \n")
print("Predicted Fertility using Decision Tree classification : \n",predicted_fertility)
print("Predicited rainfall using Decision Tree regression : \n",predicted_rainfall)
crop4=[]
for i in range(0,len(cropdb)):
...
class MainWindow4(wx.Frame):
    def __init__(self, *args, **kwargs):
        ...
        for a in range(len(crop4)):        
            self.list.Append([ crop4[a]])
